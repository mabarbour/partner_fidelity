...
Our goal here is to test whether variation in sampling effort between mutualistic and antagonistic networks can explain the results we observed in the previous models, in particular, the three-way statistical interaction with resource and consumer normalized degree. 
